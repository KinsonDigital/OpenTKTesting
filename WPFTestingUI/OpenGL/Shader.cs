...
namespace WPFTestingUI.OpenGL
{
    ...
    public class Shader
    {
        ...
        public Shader(IGLInvoker gl, string vertPath, string fragPath)
        {
            ...
            VertexShaderHandle = _gl.CreateShader(ShaderType.VertexShader, shaderSource);

            // We do the same for the fragment shader
            shaderSource = LoadSource(fragPath);
            FragmentShaderHandle = _gl.CreateShader(ShaderType.FragmentShader, shaderSource);

            // These two shaders must then be merged into a shader program, which can then be used by OpenGL.
            // To do this, create a program...
            ProgramHandle = _gl.CreateShaderProgram(VertexShaderHandle, FragmentShaderHandle);
            ...
            _gl.DestroyShader(ProgramHandle, VertexShaderHandle);
            _gl.DestroyShader(ProgramHandle, FragmentShaderHandle);
