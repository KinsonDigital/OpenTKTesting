...
namespace WPFTestingUI.OpenGL
{
    public class Texture : IDisposable
    {
        ...
        {
            var scaleX = (float)Width / MainWindow.ViewPortWidth;
            var scaleY = (float)Height / MainWindow.ViewPortHeight;
            ...
            var ndcX = _x.MapValue(0, MainWindow.ViewPortWidth, -1f, 1f);
            var ndcY = _y.MapValue(0, MainWindow.ViewPortHeight, 1f, -1f);
